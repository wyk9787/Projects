...
int main() {
  ...
  while (c == 'y') {
    ...
    printf(
        "The first one is the number we want to get to and the second one is "
        "maximum number you can add to the previous number\n");
    printf("Please separate them by a space\n");
    scanf("%d%d", &m, &n);
